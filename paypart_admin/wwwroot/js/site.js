...
$(function () {
    ...
    $('#new-biller-category').click(function (e) {
        $('.lbltag').html("New Biller Category");

        $("#page-body").load('/Home/AddBillerCategory');
    });
    $('#manage-biller-category').click(function (e) {
        $('.lbltag').html("Manage Biller Category");
        $("#label-panel-heading").html("Manage existing biller");

        $("#page-body").load('/Home/ManageBillerCategory');
    });
    ...
    $('#new-product').click(function (e) {
        $('.lbltag').html("New Product");

        $("#page-body").load('/Home/AddProduct');
    });
    $('#manage-product').click(function (e) {
        $('.lbltag').html("Manage Product");

        $("#page-body").load('/Home/ManageProduct');
    });
    $('#new-service-item').click(function (e) {
        $('.lbltag').html("New Service Item");

        $("#page-body").load('/Home/AddServiceItem');
    });
    $('#manage-service-item').click(function (e) {
        $('.lbltag').html("Manage Service Item");

        $("#page-body").load('/Home/ManageServiceItem');
    });
    $('#new-service-category').click(function (e) {
        $('.lbltag').html("New Service Category");

        $("#page-body").load('/Home/AddServiceCategory');
    });
    $('#manage-service-category').click(function (e) {
        $('.lbltag').html("Manage Service Category");

        $("#page-body").load('/Home/ManageServiceCategory');

    });
    $('#new-service').click(function (e) {
        $('.lbltag').html("New Biller Service");

        $("#page-body").load('/Home/AddService');
    });
    $('#manage-service').click(function (e) {
        $('.lbltag').html("Manage Biller Service");

        $("#page-body").load('/Home/ManageService');
    ...
    function logout() {
        ...
        window.location.href = 'http://69.167.186.129:8080/Home/Login';
        //window.location.href = 'http://fees.midesoftng.com/Home/Login';
        //window.location.href = 'http://35.227.226.230/Home/Login';
    }
    //getClassesByOrgId
